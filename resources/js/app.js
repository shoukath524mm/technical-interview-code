...
(function(window, document, $, undefined){
  ...
  // ----------------------------------- 
    ...
    // var lineData = {
    //     labels : ['Inventory 1','Inventory 2','Inventory 3','Inventory 4','Inventory 5','Inventory 6'],
    //     datasets : [
    //       {
  ...
  //   var barData = {
  //       labels : ['RM1','RM2','RM3','RM4','RM5','RM6','RM7'],
  //       datasets : [
  //         {
  //           fillColor : '#23b7e5',
  //           strokeColor : '#23b7e5',
  ...
  //   var barctx = document.getElementById("chartjs-barchart2").getContext("2d");
  //   var barChart = new Chart(barctx).Bar(barData2, barOptions2);
...
$(document).ready(function() {
    ...
    document.getElementById("demoyear").innerHTML = n;
  
});
 
// toggleClass to menu arrow
$('.arrow-r').on('click', function() {
  $(this).children('.fa-angle-down').toggleClass('rotate-element');
})
